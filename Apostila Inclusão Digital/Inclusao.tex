...
\begin{center}
	\vspace*{2cm}{\textbf{\Huge Curso de Inclusão Digital}}\\
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.9]{Figures/capa}
...
\begin{figure}[!h]
        \centering
		\includegraphics[scale=1]{Figures/cursor1}
		\label{fig:cursor1}
...
\begin{figure}[!h]
        \centering
		\includegraphics[scale=1]{Figures/cursor2}
		\label{fig:cursor2}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.3]{Figures/desktop-notes}
...
Na figura de exemplo, podemos ver que há várias pequenas imagens com um nome embaixo espalhadas pela área de trabalho. Damos o nome de ícones a essas
...
\end{itemize}
  ...
  \subsection{Relógio/Calendário}
	...
	\end{enumerate}
		...
		A Internet surgiu de um projeto militar do governo americano no início da década de 50, mas se expandiu e já conta com aproximadamente 2 bilhões de usuários, sendo, pelo menos, 100 milhões de brasileiros.
